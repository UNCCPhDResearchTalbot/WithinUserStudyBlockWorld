...
public class Forces : MonoBehaviour {
	...
	public static float avgdist = 15f;//6f + (2f/3f); // was 150 with W=1060, L=916, bufferW=50, bufferL=10 // 4ft in old = 150 units, so 4ft here is 1+1/3 grid squares.  One grid square = 5 units => 6 2/3 units = 4ft
